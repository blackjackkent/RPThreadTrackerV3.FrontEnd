			...
			<CardBlock className="card-body">
				...
				<Row>
					<Col className="text-center">
						<a className="btn btn-primary" target="_blank" rel="noopener noreferrer" href="https://chrome.google.com/webstore/detail/rpthreadtracker-quickadd/paoldhmcjbgimkcicmognhfcjmcpcopl?hl=en">
							Download for Chrome
						</a>
					</Col>
					<Col className="text-center">
						<a className="btn btn-primary" target="_blank" rel="noopener noreferrer" href="https://addons.mozilla.org/en-US/firefox/addon/rpthreadtracker-quickadd/">
