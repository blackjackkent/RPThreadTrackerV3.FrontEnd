...
const Landing = (props) => {
	...
	return (
		<Style className="landing-page">
			...
			<section
				className="home-padding-t-120 position-relative"
				id="home"
				data-parallax="scroll"
				data-image-src="images/img-2.jpg"
			>
							...
							<div className="row">
								<div className="col-lg-8 offset-lg-2 text-white text-center">
									<h1 className="home-title">
										Never lose track of your roleplay threads again!
									</h1>
									<p className="padding-t-15 home-desc">
										RPThreadTracker is a free web application that monitors your
										Tumblr collaborative writing threads and lets you know which
										ones are your turn.
									</p>
									<p className="jumbotron-buttons">
										<Link
											href="/register"
											to="/register"
											className="btn btn-custom margin-t-20"
										>
											Get Started
										</Link>
										<button
											type="button"
											className="btn btn-primary margin-t-20"
										>
											Watch Intro Video
					...
					<div className="row margin-t-30">
						<div className="col-lg-4 margin-t-20">
							<div className="features-box text-center">
								...
								<p className="padding-t-15 text-muted">
									Add a post ID for one post in the thread, and the app will keep
						...
						<div className="col-lg-4 margin-t-20">
							<div className="features-box text-center">
								...
								<p className="padding-t-15 text-muted">
									You&apos;ll get a consolidated, filterable table view of all
									threads across all characters. Never worry about messy activity
									feeds again!
								</p>
							</div>
						</div>
						<div className="col-lg-4 margin-t-20">
							<div className="features-box text-center">
								...
								<p className="padding-t-15 text-muted">
									RPThreadTracker requires no connection to your social media
									accounts -- just a post ID for each thread.
								</p>
							</div>
						</div>
					</div>
					<div className="row margin-t-30">
						<div className="col-lg-4 margin-t-20">
							<div className="features-box text-center">
								...
								<p className="padding-t-15 text-muted">
									Lots of blogs? No problem! Track all your threads in one place
									or filter the list by character.
								</p>
							</div>
						</div>
						<div className="col-lg-4 margin-t-20">
							<div className="features-box text-center">
								...
								<p className="padding-t-15 text-muted">
									Create customized public tables to let your partners know which
									threads you&apos;re working on.
								</p>
							</div>
						</div>
						<div className="col-lg-4 margin-t-20">
							<div className="features-box text-center">
								...
								<h4 className="padding-t-15">
									Add Threads Easily From Your Browser
								</h4>
								<p className="padding-t-15 text-muted">
									With the RPThreadTracker Quick-Add browser extension, you can
									track new threads rapidly and without hassle directly from
									Tumblr.
								</p>
							</div>
						</div>
						...
						<div className="col-lg-5">
							<div className="features-box">
								...
								<p className="text-muted web-desc">
									...
									ipsum dolor sit amet, consectetur adipisicing eli.Lorem ipsum
									dolor sit amet, consectetur adipisicing eli.
								</p>
					...
					<div className="row">
						<div className="col-lg-8 offset-lg-2">
							...
							<p className="section-subtitle text-muted text-center font-secondary padding-t-30">
								Etiam sed.Interdum consequat proin vestibulum class at a euismod mus
								luctus quam.Lorem ipsum dolor sit amet, consectetur adipisicing
								eli.class at a euismod mus luctus quam.
							</p>
						</div>
					</div>
					<div className="row">
						...
						<div className="col-lg-4 plan-line">
							<div className="text-center process-box">
								...
								<p className="text-muted">
									Lorem ipsum dolor Lorem ipsum sit amet.
								</p>
							</div>
						</div>
						<div className="col-lg-4 plan-line">
							...
							<div className="testimonial-box margin-t-30">
								...
								<div className="bg-gray testimonial-decs">
									<h5 className="text-muted text-center">
										<b>&quot;</b>I have been using this template for all my
										company needs for the last 3 years and couldn&apos;t be
										happier with their service and expertise.
									</h5>
								</div>
				...
				<div className="container">
					<div className="row">
						<div className="col-lg-8 offset-lg-2 text-center">
							...
							<a href="/" className="btn btn-bg-white waves-effect margin-t-20">
								Get Started <i className="mdi mdi-arrow-right" />
							</a>
						</div>
					</div>
						...
						<div className="col-lg-4">
							<div className="mt-4 pt-4">
								...
								<p className="text-muted mt-4">
									...
									<br /> <span className="d-block mt-2">9:00AM To 6:00PM</span>
								</p>
							</div>
						</div>
					...
					<div className="col-lg-12">
						...
						<div className="footer-alt">
							<div className="float-left pull-none ">
								<a href="http://www.rpthreadtracker.com">RPThreadTracker</a> &copy;{' '}
								{currentYear}{' '}
								<a href="http://blackjack-software.com">Blackjack Software</a>
							</div>
