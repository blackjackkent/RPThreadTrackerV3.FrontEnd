...
export default styled.div`
	...
	@media (min-width: 768px) {
		...
		.at-a-glance-card > .card-body .card:first-child {
			border-left: none;
		}
		.at-a-glance-card > .card-body .card:last-child {
			border-right: none;
		}
		.dashboard-summary-widget-card-body .lds-css {
			right: 30px;
