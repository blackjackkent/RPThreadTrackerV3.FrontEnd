...
describe('behavior', () => {
	it('should return true when filtering by pivot ID and row does not have property', () => {
		const filter = { pivotId: 'filterProperty', value: 'test' };
		const row = { anotherProperty: 1 };
