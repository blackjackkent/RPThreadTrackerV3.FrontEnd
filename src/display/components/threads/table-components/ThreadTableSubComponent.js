	...
	return (
		<div className="thread-table-sub-component">
			...
			<span className="control-button">
				<a className="btn btn-primary" href={thread.lastPostUrl} target="_blank">
					View <i className="fa fa-external-link" />
				</a>
			</span>
			<span className="control-button">
				<a className="btn btn-primary" href={`/thread/edit/${thread.id}`}>
					Edit <i className="fa fa-pencil" />
				</a>
			</span>
			<span className="control-button" />
			<span className="control-button">
				<a className="btn btn-primary" href={`/thread/archive/${thread.id}`}>
