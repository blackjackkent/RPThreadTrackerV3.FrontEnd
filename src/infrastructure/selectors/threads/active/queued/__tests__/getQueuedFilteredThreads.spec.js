...
import getQueuedFilteredThreads from '../getQueuedFilteredThreads';

jest.mock('../../../../common', () => ({
	filterThreadsByTag: jest.fn(),
	getFilteredTag: jest.fn()
}));
jest.mock('../getQueuedThreads', () => jest.fn());
...
describe('behavior', () => {
	it('should return threads filtered by tag', () => {
		...
		// Act
		const result = getQueuedFilteredThreads.resultFunc(getThreads(), 'tag3');
		// Assert
