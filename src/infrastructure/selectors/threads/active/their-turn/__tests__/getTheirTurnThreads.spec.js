...
describe('behavior', () => {
	it('should return empty array when shouldProcessThreads is false', () => {
		...
		// Act
		const result = getTheirTurnThreads.resultFunc(state.activeThreads, state.activeThreadsStatus);
		// Assert
	...
	it('should return threads when shouldProcessThreads is true', () => {
		...
		// Act
		const result = getTheirTurnThreads.resultFunc(getThreads(), getStatuses());
		// Assert
