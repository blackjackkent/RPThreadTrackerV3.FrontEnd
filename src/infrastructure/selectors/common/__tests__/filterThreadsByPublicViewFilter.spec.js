...
const getThreads = () => [
	{
		thread: { threadId: 1, isArchived: true },
		status: { isQueued: true, isCallingCharactersTurn: true }
	},
	{
		thread: { threadId: 2, isArchived: true },
		status: { isQueued: true, isCallingCharactersTurn: false }
	},
	{
		thread: { threadId: 3, isArchived: true },
		status: { isQueued: false, isCallingCharactersTurn: true }
	},
	{
		thread: { threadId: 4, isArchived: true },
		status: { isQueued: false, isCallingCharactersTurn: false }
	},
	{
		thread: { threadId: 5, isArchived: true }
	},
	{
		thread: { threadId: 6, isArchived: false },
		status: { isQueued: true, isCallingCharactersTurn: true }
	},
	{
		thread: { threadId: 7, isArchived: false },
		status: { isQueued: true, isCallingCharactersTurn: false }
	},
	{
		thread: { threadId: 8, isArchived: false },
		status: { isQueued: false, isCallingCharactersTurn: true }
	},
	{
		thread: { threadId: 9, isArchived: false },
		status: { isQueued: false, isCallingCharactersTurn: false }
	},
	{
		thread: { threadId: 10, isArchived: false }
	}
];
