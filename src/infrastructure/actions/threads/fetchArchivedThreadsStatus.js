...
export const FETCHED_ARCHIVED_THREADS_STATUS_CHUNK_FAILURE =	'FETCHED_ARCHIVED_THREADS_STATUS_CHUNK_FAILURE';
export function fetchedArchivedThreadsStatusChunkFailure() {
	return {
		type: FETCHED_ARCHIVED_THREADS_STATUS_CHUNK_FAILURE
	};
}
export const FETCHED_ARCHIVED_THREADS_STATUS_CHUNK_SUCCESS =	'FETCHED_ARCHIVED_THREADS_STATUS_CHUNK_SUCCESS';
